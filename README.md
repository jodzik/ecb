...
|---:|---|---|---|---|
| `DEVICE_INFO` | 1 | `READ` | `string` | Информация об устройстве |
| `LED` | 2 | `WRITE` | `{led_id: u8, state: bool}` | Задать состояние светодиода |
| `BEEP` | 3 | `WRITE`, `WRITE_NO_ANSWER` | empty | Издать звуковой сигнал |
