...
* **ERROR_DESCRIPTION_STRING** - строка ошибка, определяется если `ERR_CODE` имеет значение внутренней ошибки приложения - `ERR_INTERNAL`.

Коды ошибок:

|Наименование|Код ошибки|Описание|
|--|--|--|
|ERR_INTERNAL|0x01|Внутренняя ошибка на уровне приложения, возможно описание в поле `ERROR_DESCRIPTION_STRING`|
